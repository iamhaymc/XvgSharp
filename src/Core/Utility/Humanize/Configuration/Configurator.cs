...
using Xvg.Humanize.DateTimeHumanizeStrategy;
using Xvg.Humanize.Localisation.CollectionFormatters;
using Xvg.Humanize.Localisation.DateToOrdinalWords;
using Xvg.Humanize.Localisation.Formatters;
using Xvg.Humanize.Localisation.NumberToWords;
using Xvg.Humanize.Localisation.Ordinalizers;
...
{
    /// <summary>
    /// Provides a configuration point for Xvg.Humanize
    /// </summary>
