...
/// <summary>
/// Provides access to the resources of Xvg.Humanize
/// </summary>
public static class Resources
{
  private static readonly ResourceManager ResourceManager = new ResourceManager("Xvg.Humanize.Properties.Resources", typeof(Resources).GetTypeInfo().Assembly);
